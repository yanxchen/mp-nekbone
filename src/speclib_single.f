...
C--------------------------------------------------------------------
      ...
      ALPHA = 0.
      BETA  = 0.
      CALL ZWGJ_f (Z,W,NP,ALPHA,BETA)
      RETURN
      END
C
      SUBROUTINE ZWGLL_f (Z,W,NP)
C--------------------------------------------------------------------
C
...
C--------------------------------------------------------------------
      ...
      ALPHA = 0.
      BETA  = 0.
      CALL ZWGLJ_f (Z,W,NP,ALPHA,BETA)
      RETURN
      END
C
      SUBROUTINE ZWGJ_f (Z,W,NP,ALPHA,BETA)
C--------------------------------------------------------------------
C
...
C
 ...
 100  CONTINUE
      ...
      END
C
      SUBROUTINE ZWGLJ_f (Z,W,NP,ALPHA,BETA)
C--------------------------------------------------------------------
C
